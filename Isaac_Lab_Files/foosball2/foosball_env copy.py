...
class FoosballEnvCfg(DirectRLEnvCfg):
    ...
    object_cfg: RigidObjectCfg = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.1, 0.0, 0.79025), rot=(1.0, 0.0, 0.0, 0.0)),
    )
    # scene
...
class FoosballEnv(DirectRLEnv):
    ...
    def _reset_idx(self, env_ids: Sequence[int] | torch.Tensor | None):
        ...
        vel_noise=sample_uniform(-0.1, 0.1, (len(env_ids), 2), device=self.device)
...
def compute_rewards(
    ...
    score[ball_pop(object_pos)] = -5000
    ...
    dist_goal=dist_to_goal_white*1000
    #print(f"dist: {dist_goal}")
    #print(f"score: {score}")
    total_reward = score+2000-dist_goal
    #print(total_reward)
    return total_reward
